...
module "bedrock_kb" {
  ...
  aurora_arn        = "arn:aws:rds:us-east-1:277609840384:cluster:my-aurora-serverless"
  aurora_db_name    = "myapp"
  aurora_endpoint   = "my-aurora-serverless.cluster-c8q4cauqjdyj.us-east-1.rds.amazonaws.com"
  ...
  aurora_secret_arn = "arn:aws:secretsmanager:us-east-1:277609840384:secret:my-aurora-serverless-uZqziT"
  s3_bucket_arn = "arn:aws:s3:::bedrock-kb-277609840384"
}